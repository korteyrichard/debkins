...
export default function DashboardLayout({ user, header, children }: DashboardLayoutProps) {
    ...
    const renderNavigationItems = (items: NavigationItem[], closeSidebar = false) => {
        return items.map((item) => (
            <Link
                ...
                className={`
                    ${item.current
                        ? 'bg-blue-700 dark:bg-blue-700 text-white dark:text-white'
                        : 'text-blue-100 dark:text-blue-100 hover:bg-blue-700 dark:hover:bg-blue-700 hover:text-white dark:hover:text-white'
                    }
    ...
    const SidebarContent = ({ isMobile = false }: { isMobile?: boolean }) => (
        <div className="flex flex-col flex-grow bg-blue-600 dark:bg-blue-600 pt-5 pb-4 overflow-y-auto h-full">
            <div className="flex items-center flex-shrink-0 px-4">
                <Link href="/">
                    <div className="text-white dark:text-white text-lg font-bold flex flex-row gap-4 items-center justify-between">
                        
                        <img src='/affiliatesconnects.jpg' alt="Affiliates Connects Logo" className="w-50 h-20 mb-4 mx-auto rounded-3xl " />
                    </div>
                </Link>
            </div>
            <nav className="mt-5 flex-1 flex flex-col min-h-screen">
                ...
                <a href='https://wa.me/233502736439' className="w-[200px] ml-3 text-left mt-10 px-2 py-2 text-sm font-bold rounded-md text-white bg-green-500 dark:text-white hover:bg-green-600 dark:hover:bg-green-600 hover:text-white dark:hover:text-white">
                     Contact Support
                </a>
    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <div className="lg:pl-64 flex flex-col flex-1">
                {/* Navbar */}
                <div className="sticky top-0 z-10 flex-shrink-0 flex h-16 bg-blue-600 dark:bg-blue-600 shadow-sm lg:shadow-none">
